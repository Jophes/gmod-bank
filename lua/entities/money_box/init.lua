...
print("money_box/init.lua")

function ENT:Initialize()
	self:SetModel( "models/props_junk/cardboard_box001a.mdl" )--models/props/cs_assault/money.mdl
...
function ENT:SpawnFunction( ply, tr )
    ...
    local ent = ents.Create( "money_box" )
